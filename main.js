...
function move() {
  ...
  if (pcscore == 4) {
    ...
    text("Press The Restart Button To Replay", width / 2, height / 2 + 30)
    noLoop();
    pcscore = 0;
  }
...
function preload() {
  ball_touches_paddel = loadSound("ball_touch_paddel.wav");
